...
var file_synternet_telemetry_ping_proto_rawDesc = []byte{
...
var (
	...
	file_synternet_telemetry_ping_proto_rawDescData = file_synternet_telemetry_ping_proto_rawDesc
)

func file_synternet_telemetry_ping_proto_rawDescGZIP() []byte {
	file_synternet_telemetry_ping_proto_rawDescOnce.Do(func() {
		file_synternet_telemetry_ping_proto_rawDescData = protoimpl.X.CompressGZIP(file_synternet_telemetry_ping_proto_rawDescData)
	})
...
var file_synternet_telemetry_ping_proto_goTypes = []interface{}{
...
func file_synternet_telemetry_ping_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_synternet_telemetry_ping_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Ping); i {
			case 0:
				return &v.state
			case 1:
		...
		file_synternet_telemetry_ping_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pong); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_synternet_telemetry_ping_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_synternet_telemetry_ping_proto_rawDesc = nil
