...
const (
	UserService_Add_FullMethodName           = "/example.v1.UserService/Add"
	UserService_Get_FullMethodName           = "/example.v1.UserService/Get"
	UserService_Registrations_FullMethodName = "/example.v1.UserService/Registrations"
)
...
type UserServiceClient interface {
	...
	Registrations(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RegistrationsResponse, error)
}
...
func (c *userServiceClient) Registrations(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*RegistrationsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegistrationsResponse)
	err := c.cc.Invoke(ctx, UserService_Registrations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	Registrations(context.Context, *emptypb.Empty) (*RegistrationsResponse, error)
}
...
func _UserService_Registrations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).Registrations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_Registrations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Registrations(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_Registrations_Handler,
		},
	},
